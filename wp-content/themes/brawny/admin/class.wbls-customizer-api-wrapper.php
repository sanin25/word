<?php
	...
	class Wbls_Customizer_API_Wrapper {
		...
		public function enqueue_scripts() {
			...
			wp_localize_script( 'customizer-js', 'brawny_upgrade', array( 'message' => __( 'Get Pro for just $39', 'brawny' ), 'docs' => __( 'Documentation', 'brawny' ), 'demo' => __( 'Demo', 'brawny' ), 'support' => __( 'Ask a Question', 'brawny' ) ) );
		}
